The app structure holds the documentation information of your application, including categories, classes, variables and methods. Its object hierarchy is as follows:
